...
class Downtime(commands.Cog):
    def __init__(self, bot):
        ...
        self.bots = []
        self.watchman.start()
        self.bot.coc_client.add_events(self.maintenance_start, self.maintenance_end)

    def cog_unload(self):
        self.bot.coc_client.remove_events(self.maintenance_start, self.maintenance_end)
